...
const allCategories = async() => {/* modified */
    const objectCategories = [];
    await getAllCategories().then((response) => {/* modified */
        response.forEach((doc) => {
    ...
    return objectCategories;/* modified */
};
...
const getObjectPosts = async(idCategory, idUser) => {
    ...
    const allCategoriesCourses = await allCategories();/* modified */
